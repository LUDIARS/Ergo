...
| `ergo_resource`     | タグ駆動リソース自動選択 + 読み込み。JSON マニフェスト catalog + Clio 同重みスコアラ + バイト列 loader (MUSA Clio の C++ 移植、ネットワーク非依存) | システム | `include/ergo/resource/` | `src/resource/` | `spec/module/resource.md` | — |
